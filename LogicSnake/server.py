...
class Battlesnake(object):
    ...
    def move(self):
        ...
        snake.set_globals(data['game'], data['board'])
        safe_moves = snake.get_safe_moves(possible_moves, body, data["board"])
        safe_time = time.perf_counter() - begin_time
        #pr = cProfile.Profile()
        #pr.enable()
        smart_moves = snake.get_smart_moves(possible_moves, body, data["board"], data["you"])
        #pr.disable()
        #pr.print_stats()
